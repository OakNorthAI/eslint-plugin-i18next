...
module.exports = {
  ...
  create: function (context) {
    ...
    const notTranslatedYet = new Set([].concat.apply([], ArrObject.entries(notTranslatedYetAll).filter(([pathSuffix, _]) => context.getFilename().endsWith(ensureSlash(pathSuffix))).map(([_, contents]) => contents)));
    //----------------------------------------------------------------------
    // Helpers
    //----------------------------------------------------------------------
    function match(str) {
