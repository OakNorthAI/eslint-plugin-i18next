...
module.exports = {
  ...
  create: function (context) {
    ...
    const notTranslatedYet = new Set(Object.entries(notTranslatedYetAll).filter(([pathSuffix, _]) => context.getFilename().endsWith(ensureSlash(pathSuffix))).map(([_, contents]) => contents).flat());
    //----------------------------------------------------------------------
    // Helpers
    //----------------------------------------------------------------------
    function match(str) {
